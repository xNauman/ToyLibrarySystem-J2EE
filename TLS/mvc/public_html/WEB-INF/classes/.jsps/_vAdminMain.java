...
public class _vAdminMain extends com.orionserver.http.OrionHttpJspPage {
  ...
  static {
    ...
    __oracle_jsp_text[3] = 
    "</p>\n        </div>\n         <div id = \"menu\" >\n            <h3>Menu</h3>\n            <p><a href = \"vUserMain.jsp\">Main</a></p>\n            <p><a href = \"vBrowse.jsp\">Browse Items</a></p><p>\n          &nbsp;\n        </p>\n             <p><a href = \"vEditDetails.jsp\"> Edit personal details </a></p><p>\n          &nbsp;\n        </p><p>\n          <a href=\"vEditDetails.jsp\">\n            Generate Report&nbsp;\n          </a>\n        </p>\n      </div>\n        <div id = \"content\">\n            <p>Admin page</p>\n        </div>\n    </div>\n    </body>\n</html>".toCharArray();
    }
    catch (Throwable th) {
